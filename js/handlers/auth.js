...
//     const response = await doFetch(`${BASE_URL}/auth/create-api-key`, {
//         method: 'POST',
//         headers: {
//             'Content-Type': 'application/json',
//             Authorization: `Bearer ${localStorage.getItem('accessToken')}`, // Anta at accessToken er lagret i localStorage
//         },
//         body: name ? JSON.stringify({ name }) : undefined, // Send navnet bare hvis det er gitt
//     });
//     return response;
// }
